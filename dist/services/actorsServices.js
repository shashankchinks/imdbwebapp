...
var ActorService = /** @class */ (function () {
    ...
    ActorService.getAllActor = function (req, res) {
    ...
    ActorService.getActorById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var getActor, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, actorModel_1.actorModel.findById(req.params.id).exec()];
                    case 1:
                        getActor = _a.sent();
                        return [2 /*return*/, getActor];
                    case 2:
                        err_2 = _a.sent();
                        console.log(err_2);
    ...
    ActorService.updateActorById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var updateActorById, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, updateActorById];
                    case 3:
                        err_3 = _a.sent();
                        console.log(err_3);
    ...
    ActorService.createActor = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var createActor, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        createActor = new actorModel_1.actorModel(req.body);
                        return [4 /*yield*/, createActor.save()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, createActor];
                    case 2:
                        err_4 = _a.sent();
                        console.log(err_4);
